  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        <div>
            <h1 className="text-4xl font-bold text-white">Leads CRM</h1>
            <p className="text-lg text-gray-400 mt-1">Manage and track all your marketing leads.</p>
        </div>
        <button
      ...
      <div className="bg-gray-900 p-4 sm:p-6 rounded-xl shadow-lg">
        <div className="relative mb-4">
            ...
            <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-700 border-gray-600 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-[#d356f8]"
                value={searchQuery}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          <div>
            <label htmlFor="channel-filter" className="block text-base font-medium text-gray-300">Channel</label>
            <select 
                id="channel-filter" 
                className="mt-1 block w-full pl-3 pr-10 py-2 text-lg bg-gray-700 border-gray-600 text-white focus:outline-none focus:ring-[#d356f8] focus:border-[#d356f8] sm:text-base rounded-md"
          ...
          <div>
            <label htmlFor="group-filter" className="block text-base font-medium text-gray-300">Campaign Group</label>
            <select 
                id="group-filter" 
                className="mt-1 block w-full pl-3 pr-10 py-2 text-lg bg-gray-700 border-gray-600 text-white focus:outline-none focus:ring-[#d356f8] focus:border-[#d356f8] sm:text-base rounded-md"
          ...
          <div>
            <label htmlFor="stage-filter" className="block text-base font-medium text-gray-300">Stage</label>
            <select 
                id="stage-filter" 
                className="mt-1 block w-full pl-3 pr-10 py-2 text-lg bg-gray-700 border-gray-600 text-white focus:outline-none focus:ring-[#d356f8] focus:border-[#d356f8] sm:text-base rounded-md"
                value={filters.stage}
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-700">
            <thead className="bg-gray-950">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-400 uppercase">Name</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-400 uppercase">Company</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-400 uppercase">Channel</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-400 uppercase">Campaign Group</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-400 uppercase">Campaign</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-400 uppercase">Stage</th>
                <th className="px-6 py-3 text-right text-sm font-medium text-gray-400 uppercase">Deal Amount</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-400 uppercase">Date Added</th>
              </tr>
            </thead>
              ...
              {filteredLeads.map((lead) => (
                <tr key={lead.id} onContextMenu={(e) => handleContextMenu(e, lead)} className="hover:bg-gray-700 cursor-context-menu">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button onClick={() => handleEditClick(lead)} className="text-base font-medium text-[#e9a7fb] hover:text-[#d356f8] text-left transition duration-150 ease-in-out">
                        {lead.name}
                    </button>
                    <div className="text-base text-gray-400">{lead.email}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-base text-gray-400">{lead.company}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-base text-gray-400">{lead.channel}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-base text-gray-400">{lead.campaignGroup}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-base text-gray-400">{lead.campaign}</td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-base text-gray-400">{lead.dateAdded}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        >
          <div className="py-1">
            <button
              ...
              className="w-full text-left flex items-center px-4 py-2 text-base text-red-400 hover:bg-gray-700 hover:text-red-300"
            >
